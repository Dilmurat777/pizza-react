...
type CartItemsProps = {
  count: number; id: string; imageUrl: string; price: number; size: number; title: string; type: string 
}

const CartItems: React.FC <CartItemsProps> = ({ count, id, imageUrl, price, size, title, type }) => {
